    ...
    const selectEl = (
      <div className="relative">
        <select
          ...
          className={cn(
            "flex w-full appearance-none rounded-[8px] border border-border-control bg-surface-raised text-text shadow-[0_1px_2px_rgba(13,13,17,0.05)] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-accent disabled:opacity-50",
