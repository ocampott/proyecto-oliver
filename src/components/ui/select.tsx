      ...
      <div className={cn("flex flex-col gap-[5px]", containerClassName)}>
        ...
        <div className="relative">
          <select
            ...
            ref={ref}
            className={cn(
              "flex h-10 w-full appearance-none rounded-[8px] border border-border bg-surface-raised px-3 py-2 pr-9 text-[15px] text-text focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-accent disabled:opacity-50",
              className
            )}
            {...props}
          >
